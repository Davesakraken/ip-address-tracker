...
export function InformationSvg({ additionalClassNames }: { additionalClassNames?: string }) {
  return (
    <svg
      className={`absolute bg-white rounded-full shadow-xl -bottom-1 cursor-pointer ${additionalClassNames}`}
